...
async def main():
    ...
    automation = Automation(url = url, driver = driver)
    ...
    responde = await automation.get_title(driver)
    print("==============================")
    print(responde)
    print("==============================\n")

    #retorna a URL da página
    responde = await automation.get_url(driver)
    print("==============================")
    print(responde)
    print("==============================\n")

    # Retorna o elemento pelo seletor CSS
    responde = await automation.get_element_by_css(driver, selector = "h1")
    print("==============================")
    print(responde)
    print("==============================\n")

    # Retorna o elemento pelo XPath
    responde = await automation.get_element_by_xpath(driver, xpath = "//p[contains(@class, 'sc-dcJsrY') and contains(@class, 'eLxcFM') and contains(@class, 'sc-hgRRfv') and contains(@class, 'dfAhbD')]")
    print("==============================")
    print(responde)
    print("==============================\n")
